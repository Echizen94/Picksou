...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0b9;
...
const char     CRYPTONOTE_NAME[]                             = "Coincoin";
...
const int      P2P_DEFAULT_PORT                              = 65536;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 65678;
